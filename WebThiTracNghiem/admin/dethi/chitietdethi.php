    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <form action="?act=ctdt" method="post">
                    ...
                    <button class="btn btn-primary btn-sm"  type="submit" name="btnTimkiem"><i class="fas fa-search fa-sm"></i></button>
                </form>
                        ...
                        foreach ($dsdt as $key => $value) : extract($value) ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-danger btn-circle btn-sm" href=""><i class="fas fa-trash"></i></a>
                                </td>
                                </td>
                            </tr>
                            <?php
